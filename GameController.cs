...
namespace PokerProject
{
    ...
    public static class GameControler
    {
        ...
        public static List<DealManagement> dealManagements = new List<DealManagement>();
        #endregion
        ...
        {
            // Change the display style for the betting round
        ...
        public static void DisplayDealWon(string name, int pot)
        {
            ...
            foreach (DealManagement d in dealManagements)
            {
                if (d.Player.Name.Equals(name)){
                    d.DealsOfWin.Add(theRules.Deal);
                    d.Moneys.Add(pot);
                    d.initizalizeDealAndPot();
                }   
            }
            theView.Refresh();
        }
        ...
        private static void DisplayGameStart()
        {
            ...
            {
                DealManagement dealManagement = new DealManagement(p);
                dealManagements.Add(dealManagement);
            }
            theView.Refresh();
            theRules.NewDeal();
        }
